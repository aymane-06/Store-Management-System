...
<!-- edit User Modal -->
<div class="fixed bg-gray-900 bg-opacity-50 left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full" id="edit-user-modal">

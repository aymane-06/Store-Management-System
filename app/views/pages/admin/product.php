        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-center w-full">
                <label for="dropzone-file" class="flex flex-col h-[100px] items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                    ...
                    <input id="dropzone-file" name="image" type="file" value="<?= $image?>" class="hidden" accept=".jpg,.jpeg,.png"/>
                </label>
            </div> 
            ...
            <div class="bottom-0 left-0 flex justify-center w-full pb-4 space-x-4 md:px-4 md:relative ">
                <button type="submit" name="submit" value="1" class="text-white w-full justify-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                    Add product
                </button>

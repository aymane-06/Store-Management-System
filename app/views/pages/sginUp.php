...
include $_SERVER['DOCUMENT_ROOT'].'/Store-Management-System/app/Controller/CreateAcc.php';
...
<div class="font-[sans-serif] bg-white md:h-screen">
  <div class="grid md:grid-cols-2 items-center gap-8 h-full">
    ...
    <div class="flex items-center p-6 h-full w-full">
      <!-- /Store-Management-System/app/Controller/CreateAcc.php -->
      <form action="" method="POST" class="max-w-lg w-full mx-auto">
        <div class="mb-12">
        ...
        <div class="mt-6">
          ...
          <div class="relative flex items-center">
            <input name="email" type="text" value="<?php echo htmlspecialchars($email); ?>" required class="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Enter email" />
        ...
        <div class="mt-6">
          ...
          <div class="relative flex items-center">
            <input name="password" type="password" value="<?php echo htmlspecialchars($password); ?>" required class="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Enter password" />
